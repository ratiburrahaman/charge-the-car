...
DO.Preload.prototype = {
    create: function () {
        ...
        }, this), this.descText("Charge", 190, 60), this.descText("The Car", 70, 110)
...
DO.Game.prototype = {
    preload: function () {}, create: function () {
        ...
        this.isOver = true, this.carTime.pause(), this.bg.animations.stop(), this.timer.stop(), this.music.zizizi.pause(), totalTime = this.timesecond, document.title = "Charge" + "Game！", this.chargTween(this.currentCharg, false), b = this.add.bitmapData(640, this.world.height), b.ctx.beginPath(), b.ctx.fillStyle = "#fe0000", b.ctx.rect(0, 0, 640, this.world.height), b.ctx.fill(), c = this.add.sprite(0, 0, b), c.alpha = .29, this.time.events.repeat(300, 6, function () {
            ...
            alpha: 1
        }, 1e3, "Linear", true, 1800), e(d), f = this.add.text(this.world.centerX + 20, this.world.centerY - 60, "Game Over", {
            font: "bold 60px Arial",
            fill: "#fb0000",
            align: "center"
        }), this.timesecond = parseInt(this.timesecond / 60, 10), g = this.add.text(this.world.centerX, this.world.centerY, "" + this.timesecond + "", {
            ...
            var b = this.add.sprite(this.world.centerX, this.world.centerY, "");
            b.alpha = 0, b.anchor = {
                x: .5,
                y: .5
            }, this.add.tween(b).to({
                ...
                b.destroy(), c = this.add.sprite(0, 0, "ad"), c.alpha = 0, this.add.tween(c).to({
                    ...
                    window.location.href = "https://www.facebook.com/ratibur.rahaman.9/"
        ...
        return document.title = "", this.state.start("game")
    }, random: function (a, b) {
